...
- [ ] Firebase 專案存取權限
- [ ] Telegram Bot Token: `7659930552:AAF_jF1rAXFnjFO176-9X5fKfBwbrko8BNc`
- [ ] 測試用 Telegram 群組 ID
...
```bash
# 檢查 Bot Token 和群組 ID
curl https://api.telegram.org/bot7659930552:AAF_jF1rAXFnjFO176-9X5fKfBwbrko8BNc/getUpdates
```
